...
// Définition du fichier JSON traité	
var fichierJSON = "data/PgmBopUo.json";
//var fichierJSON = "data/PgmASA.json";
//var fichierJSON = "data/PgmOBOPOS.json";
...
d3.json(fichierJSON, function(error, data) {
	...
	document.querySelector("h4").textContent = "Source :"
		+ espace + data.source
